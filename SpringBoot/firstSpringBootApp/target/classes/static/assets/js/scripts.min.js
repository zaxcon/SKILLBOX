                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'recent':
                                ...
                                break;
                            case'popular':
                                getData('/bookshop/books/popular', {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'genre':
                                getData('/bookshop/books/genre/' + $this.data('refreshid'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'author':
                                getData('/bookshop/books/author/' + $this.data('refreshid'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                            case'tag':
                                getData('/bookshop/books/tags/' + $this.data('refreshid'), {
                                    offset: $this.data('refreshoffset'),
                                    limit: $this.data('refreshlimit')
                                });
                                break;
                                ...
                                if ($(slick.$slides[slick.$slides.length - 3]).hasClass('slick-active')) {
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                sendData('/bookshop/books/recommended')
                                                break;
                                            case'recent':
                                                sendData('/bookshop/books/recent')
                                                break;
                                            case'popular':
                                                sendData('/bookshop/books/popular')
                                                break;
                                        }
                                    }
                                }
